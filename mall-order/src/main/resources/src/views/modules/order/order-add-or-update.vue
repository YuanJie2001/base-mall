    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item
        ...
        <el-input v-model="dataForm.payType"
                  placeholder="支付方式【PAYPAL中国->101；PAYPAL香港->102；PAYPAL全球->103；支付宝->201；支付宝香港->202；支付宝全球->203；微信->301；微信香港->302；微信全球->303；银联->401；货到付款->501】"></el-input>
      </el-form-item>
    ...
    return {
      ...
      dataRule: {
        ...
        payType: [
          {
            required: true,
            message: '支付方式【PAYPAL中国->101；PAYPAL香港->102；PAYPAL全球->103；支付宝->201；支付宝香港->202；支付宝全球->203；微信->301；微信香港->302；微信全球->303；银联->401；货到付款->501】不能为空',
            trigger: 'blur'
          }
        ],
        sourceType: [
