package com.vector.mallauth.controller;

import com.alibaba.fastjson.TypeReference;
import com.vector.common.exception.BizCodeEnume;
import com.vector.common.utils.R;
import com.vector.mallauth.auth.MemberResponseVo;
import com.vector.mallauth.auth.UserLoginVo;
import com.vector.mallauth.auth.UserRegisterVo;
import com.vector.mallauth.constant.AuthConstant;
import com.vector.mallauth.feign.MemberFeignService;
import com.vector.mallauth.feign.ThirdPartFeignService;
...
//    }
    ...
    public R sendCode(@RequestParam(name = "phone", required = true) String phone) {
        ...
        if (StringUtils.isNotBlank(_code) && System.currentTimeMillis() - Long.parseLong(_code.split("_")[1]) < 60000) {
            ...
            return R.error(String.valueOf(BizCodeEnume.SMS_CODE_EXCEPTION));
        }
